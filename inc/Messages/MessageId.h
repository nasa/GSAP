...
namespace PCOE {
    ...
    enum class MessageId : std::uint64_t {
        ...
        DegreesLatitude = 0x6272320000000400L,
        DegreesLongitude = 0x6272320000000500L,
        MetersAGL = 0x6272320000000600L,
        RadiansPerSecond = 0x6272320000000700L,
        Pascal = 0x6272320000000800L,
        MetersCubedPerSecond = 0x6272320000000900L, // Volumetric Flow Rate
        Boolean = 0x6272320000001000L,
        Meters = 0x6272320000001100L,
        ModelStateEstimate = 0x6272C20000010000L,
        ModelStateVector = 0x6272C20000010100L,
        ModelInputVector = 0x6272C20000010101L,
        ModelOutputVector = 0x6272C20000010102L,
        RouteStart = 0x6272000000020000L,
        RouteEnd = 0x6272000000020001L,
        RouteClear = 0x6272000000020002L,
        RouteDeleteWP = 0x6272140000020003L,
        RouteSetWP = 0x6272380000020004L,
        ...
        CentrifugalPumpImpellerWearFailure = 0x6272380100000300L,
        CentrifugalPumpOilOverheat = 0x6272380100000301L,
        CentrifugalPumpRadialBearingOverheat = 0x6272380100000302L,
        CentrifugalPumpThrustBearingOverheat = 0x6272380100000303L,
        PneumaticValveExternalBottomLeak = 0x6272380100000400L,
        PneumaticValveExternalTopLeak = 0x6272380100000401L,
        PneumaticValveInternalLeak = 0x6272380100000402L,
        PneumaticValveSpringFailure = 0x6272380100000403L,
        PneumaticValveFrictionFailure = 0x6272380100000404L,

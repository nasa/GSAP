...
namespace PCOE {
    ...
    enum class MessageId : std::uint64_t {
        ...
        RouteStart = 0x7227000500000000L,
        RouteEnd = 0x7227000500000001L,
        RouteClear = 0x7227000500000002L,
        RouteDeleteWP = 0x7227240600000003L,
        RouteSetWP = 0x7227380600000004L,

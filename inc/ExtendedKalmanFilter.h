...
/**
 Work in progress: Still deciding how best to deal with Jacobians
**/
...
namespace PCOE {
    ...
    public:
        ...
        /**
         * Computes Jacobian for provided matrix using definition of a derivative in the case that no Jacobian is provided by user.
         * Epsilon should be either a default value or provided by user.
         *
         *
         **
         ...
         **
         *
         * @param mx    Mean vector (should be last updated -- k|k-1).
         * @param u From model, current u
         *
         **/
        const Matrix getJacobian(const Model::state_type& mx, const Model::input_type& u);

...
namespace PCOE {
    ...
    private:
         ...
         **/
        double likelihood(const std::vector<double> & zActual, const std::vector<double> & zPredicted);
         ...
         **/
        void weightedMean(const Matrix & M, const std::vector<double> & weights, std::vector<double> & result);
    ...
    public:
        ...
        **/
        ParticleFilter(Model * m, size_t N, std::vector<double> & processNoise, std::vector<double> & sensorNoise);

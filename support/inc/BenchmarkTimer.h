 ...
 *  @Version 1.0.0
 *  @brief Timer Class for benchmarking scripts. Use start and stop functions to run timer. Class
 * defined in header  for ease of use.
 *
...
namespace PCOE {
    ...
    public:
        ...
        inline static nanoseconds getTimeSinceEpoch() {
            ...
            return static_cast<nanoseconds>(high_resolution_clock::now().time_since_epoch() /
                                            nanoseconds(1));
        }

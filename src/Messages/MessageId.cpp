...
namespace PCOE {
    MessageId messageIdFromString(const std::string& key) {
        static std::unordered_map<std::string, MessageId> messages{
            ...
            {"DegreesLatitude", MessageId::DegreesLatitude},
            {"DegreesLongitude", MessageId::DegreesLongitude},
            {"MetersAGL", MessageId::MetersAGL},
            {"Rad/s", MessageId::RadiansPerSecond},
            {"Pascal", MessageId::Pascal},
            {"M^3/s", MessageId::MetersCubedPerSecond},
            {"Bool", MessageId::Boolean},
            {"Meters", MessageId::Meters},
            ...
            {"CentrifugalPumpImpellerWearFailure", MessageId::CentrifugalPumpImpellerWearFailure},
            {"CentrifugalPumpOilOverheat", MessageId::CentrifugalPumpOilOverheat},
            {"CentrifugalPumpRadialBearingOverheat", MessageId::CentrifugalPumpRadialBearingOverheat},
            {"CentrifugalPumpImpellerWearFailure", MessageId::CentrifugalPumpImpellerWearFailure},
            {"PneumaticValveExternalBottomLeak", MessageId::PneumaticValveExternalBottomLeak},
            {"PneumaticValveExternalTopLeak", MessageId::PneumaticValveExternalTopLeak},
            {"PneumaticValveInternalLeak", MessageId::PneumaticValveInternalLeak},
            {"PneumaticValveSpringFailure", MessageId::PneumaticValveSpringFailure},
            {"PneumaticValveFrictionFailure", MessageId::PneumaticValveFrictionFailure},

                        ...
                        case 't': // time
                            ...
                            case 'e': // Event
                                ...
                                switch (identifier) {
                                    ...
                                    case 'T':
                                        ...
                                        std::getline(sss, type, ')');
                                        theEvent.timeOfEvent.uncertainty(
                                            static_cast<UType>(std::stoi(type)));
                                        if (std::stoul(subEntry) >=
                                            theEvent.timeOfEvent.npoints()) {
                                            theEvent.timeOfEvent.npoints(static_cast<unsigned int>(
                                                std::stoul(subEntry) + 1));
                                        }
                                        theEvent.timeOfEvent[std::stoul(subEntry)] =
                                            std::stod(entry);
                                    ...
                                    case 'o':
                                        ...
                                        if (std::stoul(subEntry) >=
                                            theEvent.occurrenceMatrix[0].size()) {
                                            theEvent.occurrenceMatrix[0].resize(
                                                std::stoul(subEntry) + 1);
                            ...
                            case 's': // System Trajectories
                                ...
                                unsigned int sampleIndex =
                                    static_cast<unsigned int>(std::stoul(uIndex));

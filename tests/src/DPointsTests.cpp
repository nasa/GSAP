...
namespace DataPointsTests {
    ...
    void registerTests(TestContext& context) {
        context.AddTest("DPoints Init", testDPointsInit, "DPoints");
        context.AddTest("DPoints Update", testDPointsUpdate, "DPoints");
        context.AddTest("DPoints Includes", testDPointsIncludes, "DPoints");
    }
}
